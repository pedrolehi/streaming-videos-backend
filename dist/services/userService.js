...
exports.userService = {
    ...
    getKeepWatchingList: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        const userWithWatchingEpisodes = yield models_1.User.findByPk(userId, {
            include: {
    ...
    updatePassword: (id, password) => __awaiter(void 0, void 0, void 0, function* () {
        const [affectedRows, updatedUsers] = yield models_1.User.update({ password }, { where: { id }, returning: true, individualHooks: true });
        return updatedUsers[0];
    }),
};
